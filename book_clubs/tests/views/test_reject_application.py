...
class CreateRejectApplicationTestCase(TestCase, LogInTester):
    ...
    def setUp(self):
        ...
        self.url = reverse('reject_application', kwargs = {'user_id' : 2, 'club_id' : 1})

    def test_get_url(self):
        self.assertEqual(self.url, '/reject_application/2/1/')

    def test_successful_rejection_of_application(self):
    ...
    def test_user_is_not_owner_and_unsuccessful_rejection_of_application(self):
    ...
    def test_get_reject_application_when_not_logged_in(self):
